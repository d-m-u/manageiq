        ...
        lambda do |_ems, inventory_collection|
          ...
          ActiveRecord::Base.transaction do
            ...
            vms_inventory_collection.model_class
              ...
              vm.genealogy_parent = parent_miq_templates[vms_genealogy_parents[vm.id]]
            end
          end
          ...
          ActiveRecord::Base.transaction do
            ...
            miq_templates_inventory_collection.model_class
              ...
              miq_template.genealogy_parent = parent_vms[miq_template_genealogy_parents[miq_template.id]]
            end
          end
        end
      end
